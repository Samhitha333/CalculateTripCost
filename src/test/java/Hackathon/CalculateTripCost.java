...
{	
	...
	@Test (priority = 0, groups= {"Hotels","RegressionTest"})
	...
	@Test (priority = 1, groups= {"Hotels","RegressionTest"})
	...
	@Test (priority = 2, dependsOnMethods = "SearchDestination", groups= {"Hotels","RegressionTest"})
	...
	@Test( priority = 6, groups= {"Hotels","RegressionTest","SmokeTest"})
	...
	@Test (priority = 9, groups= {"Cruises","RegressionTest"})
	...
	@Test (priority = 10, dependsOnMethods = "SetCruises", groups= {"Cruises","RegressionTest"})
