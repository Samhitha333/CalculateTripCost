...
public class HotelDetails 
{
	...
	static By hotelParent = By.className("_3uQcWelb");
	static By hotelName = By.xpath("//h2[contains(@class='_2K0y-IXo', '')]/a");
	static By searchResult = By.xpath("//a[normalize-space()='Elegant Cosy Conquest']");
	static By hotelTotelCharges = By.className("_33TIi_t4");
	static By hotelPerNightCharge = By.className("_3f9mHAKH");
	...
	public static String[] GetHotelName(WebDriver driver) throws IOException 
	{
		...
		WebElement Parent = driver.findElement(hotelParent);
		Hotel_Names = Parent.findElements(hotelName);
	...
	{	
		...
		WebElement Parent = driver.findElement(hotelParent);
		Total_Charges = Parent.findElements(hotelTotelCharges);
	...
	public static String[] GetChargesPerNight(WebDriver driver) throws IOException 
	{
		...
		ChargesPerNight = Parent.findElements(hotelPerNightCharge);
	...
	public static String[] GetHotelLinks(WebDriver driver) throws IOException, InterruptedException 
	{
		...
		Hrefs = Parent.findElements(hotelName);
